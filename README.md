...
The checked-in `generated/tools.json` manifest is generated from TokenLab's public OpenAPI document plus the small MCP-only overlay in `contract/mcp-overlay.json`. Version 0.6.13 generates 78 endpoint tools; two composite discovery tools are registered at runtime.
...
- npm package: `@tokenlabai/mcp-server@0.6.13`
